...
const items = computed(() => developer.value ? [
  ...
  { label: '标准流水线', caption: '公共前置处理', icon: '⇢', to: '/developer/standard-pipelines' },
  { label: '知识流程模板', caption: '单产出 / 多产出', icon: '▦', to: '/developer/flow-templates' },
...
<template>
  <div class="shell">
    ...
    <main>
      <header class="topbar"><span class="crumb">{{ developer ? '流程开发区' : '业务工作区' }} / {{ current }}</span><span class="admin">Admin</span></header>
