...
const failureCode = /\b(?:QA_OUTPUT_INVALID|QA_EMPTY_OUTPUT|QA_PROTOCOL_INVALID|SOURCE_LINEAGE_MISSING|SOURCE_LINEAGE_MISMATCH|SERVING_CONFIG_DRIFT|GRAPH_[A-Z_]*(?:FAILED|INVALID|UNRESOLVED|AMBIGUOUS|LITERAL)|(?:LLM|OPERATOR)_[A-Z_]*(?:FAILED|INVALID|ERROR|TIMEOUT|CANCELLED))\b/
const ansi = /\u001b\[[0-?]*[ -/]*[@-~]/g
