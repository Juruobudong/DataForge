...
.typed-handle.compatible-target{transform:scale(1.24);background:#1d8c65!important;box-shadow:0 0 0 4px rgba(29,140,101,.2)}.typed-handle.snapped-target{transform:scale(1.48);background:#137956!important;box-shadow:0 0 0 6px rgba(29,140,101,.24)}.typed-handle.active-source{transform:scale(1.35);background:#2f6fed!important;box-shadow:0 0 0 5px rgba(47,111,237,.22)}.typed-handle.incompatible-target{background:#c4ccd7!important;box-shadow:0 0 0 1px #c4ccd7;opacity:.48}
</style>
