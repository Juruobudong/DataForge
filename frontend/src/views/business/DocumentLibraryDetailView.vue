...
<template>
  <section>
    ...
    <section class="panel">
      <div class="panel-head"><div><h3>已配置知识模板</h3><p>可一次选择多个已发布模板；整批成功后才会创建绑定和结果知识库。</p></div><button class="primary" :disabled="!canProcessBoundSources" :title="hasResultCleanupInProgress ? '结果知识库正在清理，完成后才能再次处理。' : ''" @click="processLibrary">批量处理待更新文件</button></div>
