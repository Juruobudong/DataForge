...
- 2026-08-17：医院 qa-agent Routing 扩展完成；新增医院/阶段 schema、Snapshot v3、双 Milvus production delivery/备份、Runtime Token/ETag、前端生产确认和 qa-agent 绑定医院 dense 检索。真实双环境验收归 C-09。
- 2026-08-18：医院运行环境与项目发布关联拆层；`dataforge-central` 可同时关联 qa-agent 与 kg-for-consultation，阶段 Target 归顶层 Deployment，授权/版本按 ProjectDeployment 隔离，医院 production URI 改为逐院手工配置。真实共享环境验收仍归 C-09。
